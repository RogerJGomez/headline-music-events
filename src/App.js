...
export default function App() {
  ...
  return (
    <>
      <div className="App">
        <Header
          title="Headline Music Events"
          style={{ color: "white", background: "#272727" }}
        >
          <Navigation>
            <a href="https://github.com/rogerjgomez" style={{ lineHeight: 0 }}>
              <i className="fa fa-github nav-icon" />
            </a>
          </Navigation>
        </Header>
        <form onSubmit={onSubmit}>
          <Grid
            style={{ background: "#7118d7", color: "white", paddingTop: "5vh" }}
          >
